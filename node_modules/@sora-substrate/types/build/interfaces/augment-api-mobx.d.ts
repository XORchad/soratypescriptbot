...
export interface StorageType extends BaseStorageType {
    ...
    bridgeMultisig: {
        ...
        dispatchedCalls: StorageDoubleMap<U8aFixed | string, BridgeTimepoint | {
            height?: any;
            index?: any;
        } | string, ITuple<[]>>;
        /**
    ...
    dexapi: {
        enabledSourceTypes: Vec<LiquiditySourceType> | null;
    };
    dexManager: {
        dexInfos: StorageMap<DEXId | AnyNumber, Option<DEXInfo>>;
    };
    electionsPhragmen: {
    ...
    permissions: {
        owners: StorageDoubleMap<PermissionId | AnyNumber, Scope | {
            Limited: any;
        } | {
            Unlimited: any;
        } | string, Vec<OwnerId>>;
        permissions: StorageDoubleMap<HolderId | string, Scope | {
            Limited: any;
        } | {
            Unlimited: any;
        } | string, Vec<PermissionId>>;
    };
    poolXyk: {
    ...
    priceTools: {
        priceInfos: StorageMap<AssetId | AnyNumber, Option<PriceInfo>>;
    };
    pswapDistribution: {
        burnRate: Fixed | null;
        /**
    ...
    tradingPair: {
        enabledSources: StorageDoubleMap<DEXId | AnyNumber, TradingPair | {
            base_asset_id?: any;
            target_asset_id?: any;
        } | string, Option<BTreeSet<LiquiditySourceType>>>;
