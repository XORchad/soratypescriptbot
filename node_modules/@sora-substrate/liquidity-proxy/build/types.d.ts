...
export declare type PrimaryMarketsEnabledAssets = {
    tbc: string[];
    xst: Record<string, {
...
export declare type QuoteIntermediate = {
    amount: FPNumber;
    fee: FPNumber;
...
export declare type SwapQuote = (inputAssetAddress: string, outputAssetAddress: string, value: NumberLike, isExchangeB: boolean, selectedSources?: LiquiditySourceTypes[], deduceFee?: boolean) => {
    result: SwapResult;
    dexId: number;
};
export declare type QuotePaths = {
    [key: string]: Array<LiquiditySourceTypes>;
};
export declare type OracleRate = {
    value: CodecString;
    lastUpdated: number;
...
export declare type PathsAndPairLiquiditySources = {
