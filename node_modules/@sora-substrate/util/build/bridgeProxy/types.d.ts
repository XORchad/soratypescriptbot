...
export declare type BridgeNetworkParam = EthNetworkParam | EvmNetworkParam | SubNetworkParam;
export declare type BridgeNetworkId = EvmNetwork | SubNetwork;
...
export declare type SupportedApps = {
