...
exports.ObservableStorageDoubleMapEntries = exports.ObservableStorageMapEntries = exports.ObservableStorageEntry = void 0;
...
class ObservableStorageDoubleMapEntries {
  constructor(_api, _tracker, _module, _entry, _key) {
    this._api = _api;
    this._tracker = _tracker;
    this._module = _module;
    this._entry = _entry;
  ...
  _start() {
    ...
    const prefix = (0, _util.u8aToHex)(storageEntry.creator.keyPrefix(this._key));
    this._unsub = this._tracker.trackPrefix(prefix, (key, value) => {
      const decodedKey = new _types.StorageKey(this._api.registry, key);
      decodedKey.setMeta(storageEntry.creator.meta);
      const [key1, key2] = decodedKey.args.map(i => i.toString());
...
exports.ObservableStorageDoubleMapEntries = ObservableStorageDoubleMapEntries;