...
var _AbstractInt = require("@polkadot/types/codec/AbstractInt");

var _Compact = require("@polkadot/types/codec/Compact");

var _Enum = require("@polkadot/types/codec/Enum");

var _Option = require("@polkadot/types/codec/Option");

var _Struct = require("@polkadot/types/codec/Struct");

var _Vec = require("@polkadot/types/codec/Vec");

var _Tuple = require("@polkadot/types/codec/Tuple");

var _definitions = require("@polkadot/types/interfaces/democracy/definitions");

var _AccountId = require("@polkadot/types/generic/AccountId");

var _LookupSource = require("@polkadot/types/generic/LookupSource");

var _Vote = require("@polkadot/types/generic/Vote");

var _Null = require("@polkadot/types/primitive/Null");
...
function getSimilarTypes(definitions, registry, _type, imports) {
  ...
  if ((0, _util.isChildClass)(_Vec.Vec, Clazz)) {
    const subDef = (0, _create.getTypeDef)(type).sub;
  ...
  } else if ((0, _util.isChildClass)(_Enum.Enum, Clazz)) {
  ...
  } else if ((0, _util.isChildClass)(_AbstractInt.AbstractInt, Clazz) || (0, _util.isChildClass)(_Compact.Compact, Clazz)) {
    possibleTypes.push('AnyNumber', 'Uint8Array');
  } else if ((0, _util.isChildClass)(_LookupSource.GenericLookupSource, Clazz)) {
    possibleTypes.push('Address', 'AccountId', 'AccountIndex', 'string', 'Uint8Array');
  } else if ((0, _util.isChildClass)(_AccountId.GenericAccountId, Clazz)) {
    possibleTypes.push('string', 'Uint8Array');
  } else if ((0, _util.isChildClass)(registry.createClass('bool'), Clazz)) {
    possibleTypes.push('boolean', 'Uint8Array');
  } else if ((0, _util.isChildClass)(_Null.Null, Clazz)) {
    possibleTypes.push('null');
  } else if ((0, _util.isChildClass)(_Struct.Struct, Clazz)) {
    const s = new Clazz(registry);
    const obj = s.defKeys.map(key => `${key}?: any`).join('; ');
    possibleTypes.push(`{ ${obj} }`, 'string', 'Uint8Array');
  } else if ((0, _util.isChildClass)(_Option.Option, Clazz)) {
    // TODO inspect container
    possibleTypes.push('null', 'object', 'string', 'Uint8Array');
  } else if ((0, _util.isChildClass)(_Vote.GenericVote, Clazz)) {
  ...
  } else if ((0, _util.isChildClass)(_Tuple.Tuple, Clazz)) {
    const subDef = (0, _create.getTypeDef)(type).sub;
